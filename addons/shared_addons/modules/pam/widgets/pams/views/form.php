<ol>
	<fieldset>
		...
		<li class="<?php echo alternator('even', ''); ?>">
			<label for="pams_id">Choose Pams</label>
			<?php echo form_dropdown('pams_id', $select_pams, $options['pams_id']); ?>
		</li>
		<? foreach($images as $no=>$captimaged){?>
		<li class="<?php echo alternator('even', ''); ?>">
			<label for="pams_id">Insert Caption <?=$no?></label>
			<?php echo form_textarea('caption_'.$no.'', $options['caption_'.$no.'']); ?>
		</li>
		<? } ?>
		<li class="<?php echo alternator('even', ''); ?>">
		...
		<li class="<?php echo alternator('even', ''); ?>">
			<label for="effect">Pams Effect</label>
			<?php echo form_dropdown('effect', $pams_effect,$options['effect']); ?>
		</li>
