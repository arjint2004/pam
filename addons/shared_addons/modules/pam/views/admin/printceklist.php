	...
	<section class="item">
		<div class="content">
				...
				<?php foreach ($otp as $gp=>$datapelangganc) { ?>
					<section class="title">
						<h4>Ceklist Penagihan & baca meter Gamplong <?php echo $gp ; ?> bulan <?=$bulan?> Tahun <?=$_POST['tahun']?></h4>
					</section>
				<table cellspacing="0" id="allset" border="1">
					<thead>
						<tr>
							...
							<th>No</th>
							<th>Alamat</th>
							<th width="150" class="collapse">Nama</th>
							<th class="collapse"><?=$bulan?></th>
							<th class="collapse"><?=$bulan_sebelum?></th>
							<th>Pakai</th>
							<th width="50">Bayar</th>
							<th width="30">Cek</th>
							<th width="60">Baca Meter </th>
							<th width="150">Tagihan bln Lain </th>
					...
					<tbody>
						...
						?> 
							<tr style="height:45px;">
								...
								<td ><?php echo $i++;?></td>
								<td >Gp <?php echo $datapelanggan['alamat'];?> (<?php echo $datapelanggan['nomor'];?>)</td>
								...
								<td class="collapse" align="right">&nbsp;</td>
								<td class="collapse" align="right">&nbsp;</td>
								<td class="collapse" align="right">&nbsp;</td>
								<td class="collapse" align="right">&nbsp;</td>
							</tr>
